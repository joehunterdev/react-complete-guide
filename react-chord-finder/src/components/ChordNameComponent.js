    ...
    switch (input.length) {
      ...
      case 3:
        ...
        //Triad: will compose of two intervals  
          ...
          // let input_intervals = []
        //  console.log(this.getInterval([input[0],input[1]]))
         input_intervals =  [this.getInterval([input[0],input[1]]),this.getInterval([input[0],input[2]])]
         console.log("input intervals: " + input_intervals)
         res = Object.keys(intervals.triad).forEach((key,val) => {
          if(this.arrayEquals(intervals.triad[key],input_intervals) === true){
             console.log("true" + key)
             console.log(input[0]+ " " + key)
             return String(input[0] +" "+ key);
          }
         });
